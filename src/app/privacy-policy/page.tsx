    ...
    <main className="container mx-auto my-12 px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          ...
          you. These may include the right to:
        </p>
        <ul className="list-disc list-inside ml-4 mt-2">
      ...
      <section>
	      ...
	      <ol type="a">
	        <li>
	          The materials on this web site are provided "as is". This web site makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights. Further, This web site does not warrant or make any representations concerning the accuracy, likely results, or reliability of the use of the materials on its Internet web site or otherwise relating to such materials or on any sites linked to this site.
	        </li>
	      </ol>
      </section>
      ...
      <section>
	      ...
	      <p>
	        The materials appearing on this web site could include technical, typographical, or photographic errors. This web site does not warrant that any of the materials on its web site are accurate, complete, or current. This web site may make changes to the materials contained on its web site at any time without notice. This web site does not, however, make any commitment to update the materials.
	      </p>
      </section>
      ...
      <section>
	     	<h3>6. Links</h3>
	      <p>
	        This web site has not reviewed all of the sites linked to its Internet web site and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by this web site. Use of any such linked web site is at the user's own risk.
	      </p>
      </section>
      ...
      <section>
	      ...
	      <p>
	        This web site may revise these terms of use for its web site at any time without notice. By using this web site you are agreeing to be bound by the then current version of these Terms and Conditions of Use.
	      </p>
      </section>
      ...
      <section>
	      ...
	      <p>
	        Any claim relating to this web site shall be governed by the laws of the State of Hawaii without regard to its conflict of law provisions.
	      </p>
