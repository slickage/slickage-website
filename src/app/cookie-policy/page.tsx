  ...
  return (
    <main className="container mx-auto my-12 px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          This Cookie Policy explains how Slickage ("we," "us," or "our") uses
          cookies and similar technologies on our website [Your Website URL]
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          ...
          work more efficiently, as well as to provide reporting information and
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside ml-4 mt-2">
          <li>
            <strong>Essential Cookies:</strong> These cookies are strictly necessary
            to provide you with services available through our Site and to enable
            some of its features, such as accessing secure areas.
          </li>
          <li>
            <strong>Performance and Functionality Cookies:</strong> These cookies
            are used to enhance the performance and functionality of our Site
          ...
          <li>
            ...
            understand how our Site is being used or how effective our marketing
            campaigns are, or to help us customize our Site for you.
          </li>
          <li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside ml-4 mt-2">
          <li>
            ...
            website you are visiting directly.
          </li>
          <li>
            <strong>Third-party cookies:</strong> These are cookies set by a
            domain other than that of the website you are visiting. This can
            happen when the website incorporates elements from other sites, such
      ...
      <section className="mb-8">
        ...
        <p className="mb-2">
          ...
          can exercise your cookie preferences by using the cookie consent tool
          on our website or by setting your web browser controls to accept or
          refuse cookies.
        </p>
        <p className="mb-2">
          ...
          being sent. However, if you disable cookies, some features or services
          on our Site may not function properly.
        </p>
        <p>
          For more information on how to control cookies, check your browser's
          help material or visit websites like <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">allaboutcookies.org</a>.
        </p>
      </section>
